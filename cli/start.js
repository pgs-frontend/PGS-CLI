...
import gradient, {cristal, mind} from 'gradient-string';
...
console.log(('\n---------------------------------------------------------------------\n'));
console.log(chalk.bold(mind(`🚀 Let's get started!\n`)));
}
...
versionCommand();
console.log(('\n---------------------------------------------------------------------\n'));
console.log(chalk.bold(cristal('- COMMANDS')));
...
console.log(('\n---------------------------------------------------------------------\n'));
console.log(chalk.bold(cristal('- Website')));
console.log(`${chalk.bold(config.website)}`);
console.log(('\n---------------------------------------------------------------------\n'));
console.log(chalk.bold(cristal('- Author')));
console.log(`${chalk.bold(config.author)}`);
}

function versionCommand() {
    console.log(chalk.bold(cristal('- VERSION')));
